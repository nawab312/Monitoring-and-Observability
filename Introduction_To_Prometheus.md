...
*Prometheus is pull-based. Prometheus does not wait for applications to send metrics. Prometheus periodically scrapes metrics. Targets expose metrics on an HTTP endpoint (usually `/metrics`)*
